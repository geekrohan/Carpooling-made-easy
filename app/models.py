...
class Vehicle(models.Model):
    ...
    plate = models.CharField(_('liscenced plate number'), max_length=10, blank=False, validators=[
        validators.RegexValidator(re.compile(
            '^[a-zA-Z]{2}[0-9]{2}[a-zA-Z]{2}[0-9]{4}$'), _('Number Plate allowed in GJ01PM1234 format.'), 'invalid')
    ...
    user_choices = (('Car', 'Car'), ('Bike', 'Bike'))
