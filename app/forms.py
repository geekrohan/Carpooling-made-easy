...
class VehicleAddForm(forms.ModelForm):
    year = forms.IntegerField(widget=forms.TextInput(attrs={'type':'number','class': 'form-control', 'required':True}),min_value=2010,max_value=2019)
    ...
    seats = forms.IntegerField(widget=forms.TextInput(attrs={'type':'number','class': 'form-control', 'required':True}), max_value=7)


    category = forms.ChoiceField(choices=(('Car', 'Car')2
                                                        ),
                                 widget=forms.Select(attrs={'class': 'form-control', 'required': True}))
